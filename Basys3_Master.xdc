...
## Switches
#set_property PACKAGE_PIN V17 [get_ports {clk_sel}]
...
## LEDs
#set_property PACKAGE_PIN U16 [get_ports {now_random[0]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {now_random[0]}]
#set_property PACKAGE_PIN E19 [get_ports {now_random[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {now_random[1]}]
#set_property PACKAGE_PIN U19 [get_ports {now_random[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {now_random[2]}]
#set_property PACKAGE_PIN V19 [get_ports {clk_22}]
#set_property IOSTANDARD LVCMOS33 [get_ports {clk_22}]
#set_property PACKAGE_PIN W18 [get_ports {clk_22}]
#set_property IOSTANDARD LVCMOS33 [get_ports {clk_22}]
